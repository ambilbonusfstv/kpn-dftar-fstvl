    ...
    <div class="card-form">
      ...
      <div class="card-form__inner">
        ...
        <div class="card-input">
          ...
          <input type="tel" id="nomor" name="nohp" class="card-input__input" v-model="cardName"  v-on:focus="focusInput" v-on:blur="blurInput" data-ref="cardName" autocomplete="off" placeholder="Masukkan Nomor Handphone" maxlength="13" required>
        </div>
